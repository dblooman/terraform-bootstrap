variable "aws_subnet_public_subnet_a_id" {}
variable "aws_subnet_public_subnet_b_id" {}
variable "aws_vpc_id" {}
...
resource "aws_nat_gateway" "nat_gateway_a" {
  ...
  subnet_id     = "${var.aws_subnet_public_subnet_a_id}"
...
resource "aws_nat_gateway" "nat_gateway_b" {
  ...
  subnet_id     = "${var.aws_subnet_public_subnet_b_id}"
  depends_on    = ["aws_internet_gateway.production"]
}
